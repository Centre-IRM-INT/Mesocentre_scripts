...
# bash submit_job_array_qsiprep.sh


study=NEMO
#subjs=$@ # uncomment for processing all subjects
subjs=(pilote2) # uncomment for processing selected subjects
...
sbatch --array=0-$len%100 $bids/code/qsiprep/ss_qsiprep.sh $bids $study ${subjs[@]}
