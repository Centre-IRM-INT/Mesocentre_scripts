...
# bash submit_job_array_xcpd.sh


study=PREDYS #TP_MASCO
#subjs=$@ # uncomment for processing all subjects
subjs=(01)   #(MAS300920221) # uncomment for processing selected subjects EX: subjs=(05 06 07)
...
sbatch --array=0-$len%100 $bids/code/xcpd/ss_xcpd.sh $bids $study ${subjs[@]}
